...
/** A small builder for clickable/hoverable chat components, used throughout the menu UI. */
public final class InteractiveText {
    ...
    private InteractiveText(Builder builder) {
